...
@author: ning
python "D:/working_memory/working_memory/scripts/machine learning train on positive probe (time generalization within and cross modal)(linear).py"
...
#    from scipy import stats as stats
    ...
    saving_dir = 'D:/working_memory/working_memory/results/train_probe_test_encode/within_cross_linear/'
    ...
    #e_= event_files[8] # debugging stuff
        ...
        ax=axes[1]
        CS = ax.contour(scores_encode.mean(0),extent=[0,2000,0,2000],cmap=plt.cm.coolwarm,
                        vmin=.5,vmax=vmax)
